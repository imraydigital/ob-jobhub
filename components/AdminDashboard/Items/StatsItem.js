...
const StatsItem = ({ switchRouteHandler }) => {
	...
	return (
		<button onClick={()=>{
			...
			<svg xmlns="http://www.w3.org/2000/svg" enableBackground="new 0 0 512 512" viewBox="0 0 512 512"><path fillRule="evenodd" d="M116.38,251.822h38.561c8.262,0,15,6.738,15,15v101.662c0,8.262-6.738,15-15,15H116.38c-8.262,0-15-6.738-15-15
	...
	c0,8.262-6.738,15-15,15h-38.561c-8.262,0-15-6.738-15-15V109.077C363.234,100.815,369.972,94.077,378.234,94.077z" clipRule="evenodd" /></svg>
		</button>
